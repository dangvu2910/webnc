...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="vi">
  ...
  <title>Đăng nhập - Bảng điều khiển Windmill</title>
    <link
        ...
        <div class="flex flex-col overflow-y-auto md:flex-row">
          <div class="h-32 md:h-auto md:w-1/2">
            <img
              ...
              src="{{ asset('vendor/admin/assets/img/login-office.jpeg') }}"
              alt="Office"
            />
            <img
              aria-hidden="true"
              class="hidden object-cover w-full h-full dark:block"
              src="{{ asset('vendor/admin/assets/img/login-office-dark.jpeg') }}"
              alt="Office"
            />
          </div>
          <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
            <div class="w-full">
              ...
              <p class="mt-4">
                  ...
                  href="{{ url('admin/pages/forgot-password') }}"
                >
                  Quên mật khẩu?
                </a>
              </p>
              <p class="mt-1">
                <a
                  class="text-sm font-medium text-purple-600 dark:text-purple-400 hover:underline"
                  href="{{ url('admin/pages/create-account') }}"
                >
                  Đăng ký
                </a>
              </p>
