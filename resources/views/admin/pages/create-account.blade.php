...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="vi">
  ...
  <title>Đăng ký - Bảng điều khiển Windmill</title>
    <link
        ...
        <div class="flex flex-col overflow-y-auto md:flex-row">
          <div class="h-32 md:h-auto md:w-1/2">
            <img
              ...
              src="{{ asset('vendor/admin/assets/img/create-account-office.jpeg') }}"
              alt="Office"
            />
            <img
              aria-hidden="true"
              class="hidden object-cover w-full h-full dark:block"
              src="{{ asset('vendor/admin/assets/img/create-account-office-dark.jpeg') }}"
              alt="Office"
            />
          </div>
