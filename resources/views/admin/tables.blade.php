...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="vi">
  ...
  <title>Bảng - Bảng điều khiển Windmill</title>
    <link
            ...
            <li class="relative px-6 py-3">
              ...
              <template x-if="isPagesMenuOpen">
                ...
                >
                  ...
                  >
                    <a class="w-full" href="{{ url('admin/pages/login') }}">Đăng nhập</a>
                  </li>
                  <li
                    class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                  >
              ...
              <template x-if="isPagesMenuOpen">
                ...
                >
                  ...
                  <li
                    class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                  >
                    <a class="w-full" href="{{ url('admin/pages/blank') }}">Blank</a>
                  </li>
                </ul>
              </template>
            </li>
                ...
                <table class="w-full whitespace-no-wrap">
                  ...
                  >
                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                      ...
                      <td class="px-4 py-3 text-xs">
                        <span
                          class="px-2 py-1 font-semibold leading-tight text-orange-700 bg-orange-100 rounded-full dark:text-orange-100 dark:bg-orange-600"
                        >
                          Đang chờ
                        </span>
                      </td>
                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                      <td class="px-4 py-3">
                        <div class="flex items-center text-sm">
                          ...
                          <div>
                            <p class="font-semibold">Lương Văn Tài</p>
                            <p class="text-xs text-gray-600 dark:text-gray-400">
                              Thanh Hóa
                            </p>
                          </div>
                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                      <td class="px-4 py-3">
                        <div class="flex items-center text-sm">
                          ...
                          <div>
                            <p class="font-semibold">Đỗ Văn Nam</p>
                            <p class="text-xs text-gray-600 dark:text-gray-400">
                              Quy Nhơn
                            </p>
                          </div>
                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                      <td class="px-4 py-3">
                        <div class="flex items-center text-sm">
                          ...
                          <div>
                            <p class="font-semibold">Cao Thị Oanh</p>
                            <p class="text-xs text-gray-600 dark:text-gray-400">
                              Biên Hòa
                            </p>
                          </div>
                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                      <td class="px-4 py-3">
                        <div class="flex items-center text-sm">
                          ...
                          <div>
                            <p class="font-semibold">Ngô Minh Phương</p>
                            <p class="text-xs text-gray-600 dark:text-gray-400">
                              Thủ Đức
                            </p>
                          </div>
                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                      <td class="px-4 py-3">
                        <div class="flex items-center text-sm">
                          ...
                          <div>
                            <p class="font-semibold">Lý Thanh Tùng</p>
                            <p class="text-xs text-gray-600 dark:text-gray-400">
                              Bình Dương
                            </p>
                          </div>
                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                      <td class="px-4 py-3">
                        <div class="flex items-center text-sm">
                          ...
                          <div>
                            <p class="font-semibold">Mai Thị Kim</p>
                            <p class="text-xs text-gray-600 dark:text-gray-400">
                              Long Xuyên
                            </p>
                          </div>
                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                      <td class="px-4 py-3">
                        <div class="flex items-center text-sm">
                          ...
                          <div>
                            <p class="font-semibold">Trịnh Văn Quân</p>
                            <p class="text-xs text-gray-600 dark:text-gray-400">
                              Rạch Giá
                            </p>
                          </div>
                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                      <td class="px-4 py-3">
                        <div class="flex items-center text-sm">
                          ...
                          <div>
                            <p class="font-semibold">Đinh Thị Hương</p>
                            <p class="text-xs text-gray-600 dark:text-gray-400">
                              Mỹ Tho
                            </p>
                          </div>
                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                      <td class="px-4 py-3">
                        <div class="flex items-center text-sm">
                          ...
                          <div>
                            <p class="font-semibold">Hồ Văn Sơn</p>
                            <p class="text-xs text-gray-600 dark:text-gray-400">
                              Pleiku
                            </p>
                          </div>
                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                      <td class="px-4 py-3">
                        <div class="flex items-center text-sm">
                          ...
                          <div>
                            <p class="font-semibold">Phạm Thị Thanh</p>
                            <p class="text-xs text-gray-600 dark:text-gray-400">
                              Buôn Ma Thuột
                            </p>
                          </div>
