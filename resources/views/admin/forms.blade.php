...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="vi">
  ...
  <title>Biểu mẫu - Bảng điều khiển Windmill</title>
    <link
  ...
  <div class="py-4 text-gray-500 dark:text-gray-400">
    ...
    <ul class="mt-6">
      <li class="relative px-6 py-3">
        <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200" href="{{ url('admin') }}">
    ...
    <ul>
      <li class="relative px-6 py-3">
        <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200" href="{{ url('admin/forms') }}">
          <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <li class="relative px-6 py-3">
        <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200" href="{{ url('admin/cards') }}">
          <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <li class="relative px-6 py-3">
        ...
        <a class="inline-flex items-center w-full text-sm font-semibold text-gray-800 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100" href="{{ url('admin/buttons') }}">
          <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <li class="relative px-6 py-3">
        <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200" href="{{ url('admin/modals') }}">
          <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <li class="relative px-6 py-3">
        ...
        <template x-if="isPagesMenuOpen">
          <ul
            ...
            aria-label="submenu">
            <li class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"><a class="w-full" href="{{ url('admin/pages/login') }}">Đăng nhập</a></li>
            <li class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"><a class="w-full" href="{{ url('admin/pages/create-account') }}">Đăng ký</a></li>
            <li class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"><a class="w-full" href="{{ url('admin/pages/forgot-password') }}">Quên mật khẩu</a></li>
            <li class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"><a class="w-full" href="{{ url('admin/pages/404') }}">404</a></li>
            <li class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"><a class="w-full" href="{{ url('admin/pages/blank') }}">Trang trống</a></li>
          </ul>
        </template>
      </li>
    </ul>
              ...
              <template x-if="isPagesMenuOpen">
                ...
                >
                  ...
                  <li
                    class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                  >
                    <a class="w-full" href="{{ url('admin/pages/create-account') }}">
                      Đăng ký
                    </a>
                  </li>
                  <li
                    class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                  >
                    <a class="w-full" href="{{ url('admin/pages/forgot-password') }}">
                      Quên mật khẩu
                    </a>
                  </li>
                  <li
          ...
          <div class="container px-6 mx-auto grid">
            ...
            >
              <div class="flex items-center">
                ...
                <span>Hãy đánh dấu dự án này trên GitHub</span>
              </div>
              <span>Xem thêm →</span>
            </a>
            ...
            >
                ...
                <div class="mt-2">
                  ...
                  >
                    <input
                      ...
                      value="busines"
                    />
                    <span class="ml-2">Doanh nghiệp</span>
                  </label>
                </div>
              </div>
              ...
              <label class="block mt-4 text-sm">
                <span class="text-gray-700 dark:text-gray-400">Tin nhắn</span>
                <textarea
            ...
            >
              <label class="block text-sm">
                <span class="text-gray-700 dark:text-gray-400">Biểu tượng trái</span>
              ...
              <label class="block mt-4 text-sm">
                <span class="text-gray-700 dark:text-gray-400">Biểu tượng phải</span>
                <!-- focus-within sets the color for the icon when input is focused -->
                <div
                  class="relative text-gray-500 focus-within:text-purple-600 dark:focus-within:text-purple-400"
                >
